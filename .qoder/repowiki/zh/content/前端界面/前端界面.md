...
- [chat.html:1-95](file://src/main/resources/templates/chat.html#L1-L95)
- [styles/chat.css:1-13](file://src/main/resources/static/styles/chat.css#L1-L13)
- [styles/base.css:1-100](file://src/main/resources/static/styles/base.css#L1-L100)
...
### UI 组件的响应式设计与视觉风格
- 主题以 CSS 变量定义（色彩、霓虹发光、间距、字体），方便整体换肤
- 主样式 chat.css 通过 @import 组合，按模块拆分子样式，便于按需调整
- 页面布局为三栏：左侧 Agent 列表、中部对话区、右侧调试面板，适合桌面端；可通过媒体查询在小屏收起边栏/调试区
- 标题与分割线使用渐变与发光增强可读性与层次感

章节来源
- [styles/base.css:1-100](file://src/main/resources/static/styles/base.css#L1-L100)
- [styles/chat.css:1-200](file://src/main/resources/static/styles/chat.css#L1-L200)
...
- 无障碍要点：
  ...
  - 颜色对比度满足 WCAG（当前深色主题已较高对比，但需注意自定义颜色）
...
## 结论
前端以模块化与 SSE 为核心构建，状态集中管理、调试面板提供强可观测性，Markdown 与代码高亮保障了高质量的信息呈现。结合主题系统与组件化样式，可实现灵活的主题与布局定制；通过扩展事件与模块接口，可平滑叠加新功能。
